...
export class Authorize implements CanActivate {
  ...
  private authorizeHttpRequest(context: ExecutionContext) {
    ...
    return this.sendAuthorizationRequest({ token, requestType: 'http' }, request, 'http')
  }
  ...
  private authorizeRpcRequest(context: ExecutionContext) {
    ...
    return this.sendAuthorizationRequest({ token, requestType: 'rpc' }, data, 'rpc')
  }
  ...
  private authorizeWsRequest(context: ExecutionContext) {
    ...
    return this.sendAuthorizationRequest({ token, requestType: 'ws' }, request, 'ws')
  }
